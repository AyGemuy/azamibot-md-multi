...
try {
  ...
  console.log("CFonts 'Lightweight WhatsApp Bot' berhasil ditampilkan.");
} catch (error) {
...
try {
  ...
  console.log(`CFonts '${name}' berhasil ditampilkan.`);
} catch (error) {
...
try {
  ...
  console.log("CFonts untuk argumen command line berhasil ditampilkan.");
} catch (error) {
  console.error("Gagal menampilkan CFonts untuk argumen command line:", error);
}
try {
  protoType();
  console.log("Fungsi protoType() berhasil dijalankan.");
} catch (error) {
  console.error("Gagal menjalankan fungsi protoType():", error);
}
try {
  serialize();
  console.log("Fungsi serialize() berhasil dijalankan.");
} catch (error) {
...
try {
  ...
  console.log("Koneksi WhatsApp berhasil dibuat.");
} catch (error) {
...
try {
  ...
  console.log("Objek global berhasil diassign.");
} catch (error) {
