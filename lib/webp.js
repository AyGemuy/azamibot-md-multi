...
var _readChunkHeader2 = function() {
...
var _read2 = function() {
  var _read3 = _asyncToGenerator(function*(path) {
    let fd = yield fs.open(path, "r"), out = {}, keepLooping = true, first = true;
    let {
      fileSize
    } = yield _classPrivateMethodGet(this, _readHeader, _readHeader2).call(this, fd);
    while (keepLooping) {
      let {
        fourCC,
        size
      } = yield _classPrivateMethodGet(this, _readChunkHeader, _readChunkHeader2).call(this, fd);
      switch (fourCC) {
        case "VP8 ":
          if (!out.vp8) {
        ...
        case "ANIM":
          if (!out.anim) {
            let {
              ...
              bgColor,
              loopCount
            } = yield _classPrivateMethodGet(this, _readChunk_ANIM, _readChunk_ANIM2).call(this, fd, size);
            out.anim = {
