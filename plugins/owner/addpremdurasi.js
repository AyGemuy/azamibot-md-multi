...
let handler = async (m, {
  ...
  await conn.reply(m.chat, `${command.includes("min") || command.includes("kurang") ? "Mengurangi" : "Menambah"} durasi premium @${(who || "").replace(/@s\.whatsapp\.net/g, "")} sebanyak *${durasi} hari*`, m, {
    mentions: [who]
  });
};
