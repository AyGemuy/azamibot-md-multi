...
export async function before(m) {
  ...
  if (m.messageStubType == 21) {
    ...
    try {
      pp = API("wudysoft", "/api/canvas/canvafy", {
        avatar: pp,
        background: bg,
        title: add ? "Welcome" : "Goodbye",
        description: `${add ? "Hello" : "Sayonara"} ${name} | ${add ? "Welcome to" : "Leaving from"} ${namegc}`,
        borderColor: add ? "3495eb" : "eb4034",
