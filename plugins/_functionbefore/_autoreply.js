...
export async function before(m) {
  ...
  if (m.text.toLowerCase() == "bot") {
    ...
    else await this.sendFile(m.chat, `https://github.com/clicknetcafe/Databasee/raw/main/sfx/${sfx.getRandom()}.mp3`, "", "", null, true, {}, true);
  }
...
const sfx = ["BANG%20UDAH%20BANG", "BOOM", "Emang%20Boleh%20versi%20anak%20kecil", "Gwenchana%20Kumenahan%20rasa%20sakit%20-Dean%20KT", "What%20the%20dog%20doing", "ack", "acumalaka_04ZUCRu", "agus-lapar", "anime-wow-sound-effect", "apaan-tuh", "aughhhhh-aughhhhh", "ayo-pukul-aku", "bawakdewak", "bercanda-bercandyaaa", "boleh", "bombastic-side-eye", "dari-mana-duit-nya", "directed-by-robert-b_voI2Z4T", "eh-eh-ehhhh", "final-chapter", "frog-laughing-meme", "grup-kontol", "gwenchana", "haah-lahhhhhh", "hansen-caunima-le-caunima-le", "hansen-lu-memang-anak-lanciau-mobile-legend", "kaget", "kerja-bagus-ff", "ketawa-bajaj-bajuri", "kiw-kiw-kuk-geruk-empuk-jeru", "krik-krik-krik", "kunti-bogel-anak-jurik", "memang-babi-kau-nih", "movie_1", "musuh-terlihat-ff", "patrick-pembohong-kau-pembohong", "pelan-pelan-pak-sopir_lQcRQb8", "rawr-krakatau", "sadar-diri-kamu_pqJ7DGg", "sangat-cocok-hansen", "sepuh", "spiderman-meme-song", "spongebob-fail", "suiiiiiiiiiii", "vestia-zeta-aa-jangan-dong-huhh-janganlah-yada", "what-the-hellllllllllll"];